            ...
            "undefined" != typeof self && self, e.exports = function() {
                ...
                return function() {
                    ...
                    for (var d = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i, p = function(e) {
                        ...
                        }, v = [], f = 0; f < 256; ++f) v.push((f + 256).toString(16).substr(1));
                    var l = function(e) {
                    ...
                    var b = ["type"],
                        ...
                        O = {
                            ...
                            InitiateCheckout: function(e) {
                                return [
                                    ["track", "InitiateCheckout", a()({}, L(T(e)), e.contents && {
                            ...
                            AddPaymentInfo: function(e) {
                                return [
                                    ["track", "AddPaymentInfo", a()({}, L(T(e)), e.contents && {
                                        content_ids: e.contents.map((function(e) {
                                            return e.id
                                        })),
                                        content_type: "product"
                            ...
                            Purchase: function(e, n) {
                                ...
                                return [
                                    ["track", "Purchase", a()({}, L(T(e)), e.contents && {
                                        content_ids: e.contents.map((function(e) {
                                            return e.id
                                        })),
                                        content_type: "product"
                        ...
                        R = {
                            ...
                            AddProductImpression: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", N(e.origin), "Product Impressions", {
                                        nonInteraction: !0
                                    }]
                                ])
                            },
                            ...
                            ViewContent: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", N(e.origin), "View Content", n, {
                                        nonInteraction: !0
                                    }]
                                ])
                            },
                            ...
                            CheckoutStep: function(e) {
                                ...
                                return [
                                    ...
                                    ["send", "event", N(e.origin), "Checkout Step " + n.step]
                                ])
                            },
                            Purchase: function(e) {
                                var n = (e.contents || []).map((function(e) {
                                ...
                                return ["id", "affiliation", "revenue", "tax", "shipping", "coupon"].forEach((function(n) {
                                    ...
                                    ["send", "event", N(e.origin), "Purchase"]
                                ])
                            },
                            Lead: function(e) {
                                var n = e.category,
                    ...
                    var ie, ce, ae, ue, se = {
                        ...
                        Ve = function(e, n) {
                            var t, r;
                            t = De, r = e, Object.prototype.hasOwnProperty.call(t, r) || (De[e] = n)
                        },
                        je = function(e, n) {
                            Object.keys(De).forEach((function(t) {
                                De[t].call(void 0, e, function(e) {
                        ...
                        Me = ((ae = {})[Fe.FACEBOOK_PIXEL] = O, ae[Fe.GOOGLE_ANALYTICS] = R, ae[Fe.GOOGLE_TAG_MANAGER] = X, ae[Fe.WIX_ANALYTICS] = Q, ae[Fe.BI_ANALYTICS] = te, ae[Fe.GTAG] = se, ae[Fe.GLOBAL_GTAG] = Ee, ae[Fe.VK_RETARGETING] = {
                            PageView: function() {
                                return [
                                    []
                                ]
                            }
                        }, ae[Fe.YANDEX_METRICA] = Pe, ae[Fe.TIKTOK_PIXEL] = Ge, ae),
                        Ye = ((ue = {})[Fe.WIX_DEVELOPERS_ANALYTICS] = function(e, n) {
                            if (e) {
                                if (window) {
                        ...
                        Be = function() {
                            ...
                            return n.isChannelPredefined = function(e) {
                                ...
                                e.events = Me[e.name], e.events.publicTracking && e.events.publicTracking instanceof Function && e.events.publicTracking()
...
//# sourceMappingURL=/static/services/wix-thunderbolt/dist/reporter-api.f47a5099.chunk.min.js.map